...
**
|
 3D Hero, Stats, 8 Service Cards (3D tilt), Why Choose Us, Testimonials, Timeline, CTA 
|
|
**
About
**
|
 Flipping 3D Lawyer Cards, Awards, Achievements, Full Timeline 
|
|
**
Services
**
|
 Expandable Accordion Cards for 8 Practice Areas 
|
|
**
Case Studies
**
|
 Cinematic Problem → Strategy → Result storytelling layout 
|
|
**
Blog
**
|
 Editorial layout, Featured Hero, Category Filters, Reading Progress 
|
|
**
Contact
**
|
 Booking Form, Calendar UI, Google Maps, FAQ, 
**
